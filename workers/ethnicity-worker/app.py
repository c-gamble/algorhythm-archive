...
from helpers import get_ethnicity_distribution
import sys
import traceback
...
def test_route():
    ...
    return "ethnicity worker is live"


@app.route("/ethnicity-distribution", methods=["POST"])
def ethnicity_distribution_endpoint():
    ...
    try:
        ...
        ethnicity_distribution = get_ethnicity_distribution(
            lyrics,
            audio_features,
            additional_features,
        )

        return jsonify(ethnicity_distribution), 200
